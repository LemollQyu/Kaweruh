		...
		<>
			...
			<div className="w-full px-3 lg:px-24 border-dashed border-b-[1.9px]">
				...
				<div className="w-full border-dashed border-x-[1.9px] flex lg:flex-row flex-col   border-x-[1.9px]">
					<h1 className="font-Alliance font-bold text-2xl md:text-2xl font-bold  w-3/4 border-r-[1.9px] border-dashed py-2 pr-2">Start your  startup‘s growth      right here. We made Resources  that got you covered from 0 to IPO. Knowledge applicable today.</h1>
