		...
		<>
			<div className="lg:px-24 px-3 border-dashed border-b-[1.9px] w-full">
				<div className="border-dashed border-x-[1.9px] w-full">
					<div className="border-b-[1.9px] border-dashed">
						<h1 className="lg:w-1/2 w-full text-2xl lg:text-4xl text-bold font-[Alliance]">
							 {/* Style will be inherited from the parent element */}
						  <Typewriter
							words={["We Partner-up with great companies. Here are some of our projects"]}
							loop={1}
							cursor
							cursorStyle='.'
							typeSpeed={70}
					...
					<div className="mt-10  flex md:flex-row  flex-col justify-between gap-y-4 gap-x-1 md:gap-x-4">
						<div className='lg:w-1/2 h-[440px] lg:h-[440px] border flex flex-col gap-y-4 rounded-xl p-5 lg:p-10'>
							<Link href="https://vercel.com" className="w-full h-[300px]  flex items-center">
								<Image 
						...
						<div className='lg:w-1/2 h-[440px] lg:h-[440px] border flex flex-col gap-y-2 rounded-xl p-5 lg:p-10'>
							...
							<div className="w-full h-[100px]  flex items-center gap-x-3 px-5">
								...
								<div className="w-full h-[60px] px-3 py-1">
									<h1 className="font-[Alliance] text-xl font-bold">Foremon</h1>
									<p className="text-sm font-extralight">Foremon Is the best Pisture</p>
