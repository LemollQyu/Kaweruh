	...
	return (
		<>
			<div className="w-full px-3 lg:px-24 border-dashed border-b-[1.9px]">
				<div className="w-full border-dashed border-x-[1.9px] flex items-center justify-between">
					...
					<Link href="/html" className="group flex border w-[360px] h-[364px] transition-all duration-600 hover:bg-gray-200/[.06] flex-col justify-around p-5 w-full rounded-xl">
						<div className="flex items-center justify-center  rounded-lg">
							<div className="w-[100px] h-[100px] group-hover:h-[110px] group-hover:w-[110px] transition-all duration-600">
								...
								<path className="dark:stroke-white stroke-gray-600" d="M52.9365 70.1407L75.8721 56.8445" className="dark:stroke-white stroke-gray-600" strokeWidth="0.8" strokeLinecap="round" strokeLinejoin="round"/>
					...
					<Link href="/html" className="group flex border w-[360px] h-[364px] transition-all duration-600 hover:bg-gray-200/[.06] flex-col justify-around p-5 w-full rounded-xl">
						<div className="flex items-center justify-center  rounded-lg">
							<div className="w-[100px] h-[100px] group-hover:h-[110px] group-hover:w-[110px] transition-all duration-600">
								<svg className="w-full h-full object-cover" viewBox="0 0 84 84" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path d="M37.9766 51.8297H47.8063V32.6169" stroke="#9A9A9A" stroke-opacity="0.5" stroke-width="0.8"/>
									<path d="M17.8711 69.2554V51.8298H37.5307" stroke="white" stroke-width="0.8"/>
									<path d="M17.8711 21.8935V4.46802H48.2541" stroke="white" stroke-width="0.8"/>
									<path d="M67.4668 15.1914L67.4668 32.6169L37.0838 32.6169" stroke="white" stroke-width="0.8"/>
									<path d="M67.4668 62.5532L67.4668 79.9788L37.0838 79.9788" stroke="white" stroke-width="0.8"/>
									<path d="M37.5312 32.6169V79.9786" stroke="white" stroke-width="0.8"/>
									<path d="M67.4668 32.6169V64.7872" stroke="white" stroke-width="0.8"/>
									<path d="M47.8066 4.46802V33.0638" stroke="white" stroke-width="0.8"/>
									<path d="M17.8711 68.8085V18.3191" stroke="white" stroke-width="0.8"/>
								</svg>
					...
					<Link href="/html" className="group flex border w-[360px] h-[364px] transition-all duration-600 hover:bg-gray-200/[.06] flex-col justify-around p-5 w-full rounded-xl">
						...
						<div className="flex flex-col gap-2">
							...
							<p className="text-sm font-extralight">Whether you're looking to track user behavior on your website or want to collect data for marketing purposes, we can help you get the job done.</p>
						</div>
					</Link>
